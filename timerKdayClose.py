...
if __name__ == '__main__':
    ...
    schedKdayCloseTime0=datetime.datetime(year,month,day,18,22)    #设置日线收盘时间，当天16:30
    schedKdayCloseTime1=datetime.datetime(year,month,day+1,18,22)    #设置日线收盘时间，次日16:30
