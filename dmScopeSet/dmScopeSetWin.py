...
class dmScopeSet ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"config配置代码范围", pos = wx.DefaultPosition, size = wx.Size( 484,367 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.txt_fbqx_dmscope = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer13.Add( self.txt_fbqx_dmscope, 0, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer152.Add( self.btn_confirm, 0, wx.ALL, 5 )
		...
		self.btn_confirm.Bind( wx.EVT_BUTTON, self.btn_dmScopesetConfirm )
